...
exports.ScriptViewerService = void 0;
...
class ScriptViewerService {
     ...
     */
    async archiveScriptFile(filePath) {
        const normalizedPath = path.normalize(filePath);
        // Validate extension
        if (!this.validateExtension(normalizedPath)) {
            throw new Error(`Only script files allowed (${this.allowedExtensions.join(', ')})`);
...
exports.ScriptViewerService = ScriptViewerService;
//# sourceMappingURL=ScriptViewerService.js.map