...
# Test suite for tracking CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../tracking-cli.sh"

# Initialize test environment
init_test_environment "tracking CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "tracking"
...
assert_command_exists "$CLI_SCRIPT" "stats"
assert_command_exists "$CLI_SCRIPT" "report"
assert_command_exists "$CLI_SCRIPT" "clean"
