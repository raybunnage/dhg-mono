...
# Test suite for registry CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../registry-cli.sh"

# Initialize test environment
init_test_environment "registry CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "registry"
...
assert_command_exists "$CLI_SCRIPT" "list"
assert_command_exists "$CLI_SCRIPT" "search"
assert_command_exists "$CLI_SCRIPT" "add"
assert_command_exists "$CLI_SCRIPT" "update"
assert_command_exists "$CLI_SCRIPT" "remove"
assert_command_exists "$CLI_SCRIPT" "validate"
assert_command_exists "$CLI_SCRIPT" "sync"
