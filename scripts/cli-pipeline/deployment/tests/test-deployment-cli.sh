...
# Test suite for deployment CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../deployment-cli.sh"

# Initialize test environment
init_test_environment "deployment CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "deployment"
...
assert_command_exists "$CLI_SCRIPT" "validate-all"
assert_command_exists "$CLI_SCRIPT" "status"
assert_command_exists "$CLI_SCRIPT" "health-check"
assert_command_exists "$CLI_SCRIPT" "history"
