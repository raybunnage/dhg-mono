...
# Test suite for shared-services CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../shared-services-cli.sh"

# Initialize test environment
init_test_environment "shared-services CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "shared-services"
...
assert_command_exists "$CLI_SCRIPT" "status"
