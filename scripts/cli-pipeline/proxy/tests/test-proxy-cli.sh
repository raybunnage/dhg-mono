...
# Test suite for proxy CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../proxy-cli.sh"

# Initialize test environment
init_test_environment "proxy CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "proxy"
...
assert_command_exists "$CLI_SCRIPT" "start"
assert_command_exists "$CLI_SCRIPT" "stop"
assert_command_exists "$CLI_SCRIPT" "status"
assert_command_exists "$CLI_SCRIPT" "list"
assert_command_exists "$CLI_SCRIPT" "start-all"
assert_command_exists "$CLI_SCRIPT" "stop-all"
