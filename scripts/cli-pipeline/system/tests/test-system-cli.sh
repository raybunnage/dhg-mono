...
# Test suite for system CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../system-cli.sh"

# Initialize test environment
init_test_environment "system CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "system"
...
assert_command_exists "$CLI_SCRIPT" "verify-setup"
assert_command_exists "$CLI_SCRIPT" "health-check"
assert_command_exists "$CLI_SCRIPT" "list-services"
