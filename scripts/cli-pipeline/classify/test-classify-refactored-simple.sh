...
# Simple test suite for classify-cli-refactored.sh
# Tests basic routing without executing TypeScript commands
...
echo "Testing classify-cli-refactored.sh (Simple)"
echo "=========================================="
...
# Test health check (this actually works)
test_command "health-check" "health-check"

# Test command routing (just check if commands are recognized)
test_routing "list" "list"
test_routing "classify-subjects" "classify-subjects"
test_routing "extract-titles" "extract-titles"
test_routing "create" "create"
