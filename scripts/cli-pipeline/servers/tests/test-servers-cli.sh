...
# Test suite for servers CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../servers-cli.sh"

# Initialize test environment
init_test_environment "servers CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "servers"
...
assert_command_exists "$CLI_SCRIPT" "list-running"
assert_command_exists "$CLI_SCRIPT" "list-available"
