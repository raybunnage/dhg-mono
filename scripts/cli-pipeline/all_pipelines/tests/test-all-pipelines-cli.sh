...
# Test suite for all_pipelines CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../all-pipelines-cli.sh"

# Initialize test environment
init_test_environment "all_pipelines CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "all_pipelines"
...
assert_command_exists "$CLI_SCRIPT" "health-checks"
assert_command_exists "$CLI_SCRIPT" "run-all"
