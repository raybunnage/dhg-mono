...
show_help() {
  ...
  echo ""
  echo "SYSTEM:"
  echo "  * health-check            Check if the document pipeline is working properly (25 uses)"
  echo "    help                    Show this help message"
  echo ""
  echo "EXAMPLES:"
  echo ""
  echo "PROCESSING:" 
  echo "  # Process documents in the system"
  echo "  ./document-cli.sh process-documents"
  echo ""
  echo "  # Extract content from documents"
  echo "  ./document-cli.sh extract-document-content"
  echo ""
  echo "SYSTEM:"
