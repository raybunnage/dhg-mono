...
# Test suite for refactor_tracking CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../refactor-tracking-cli.sh"

# Initialize test environment
init_test_environment "refactor_tracking CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "refactor_tracking"
