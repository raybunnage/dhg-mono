...
# Test suite for utilities CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../utilities-cli.sh"

# Initialize test environment
init_test_environment "utilities CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "utilities"
...
assert_command_exists "$CLI_SCRIPT" "check-env"
assert_command_exists "$CLI_SCRIPT" "fix-vite-env"
assert_command_exists "$CLI_SCRIPT" "diagnose-vite"
assert_command_exists "$CLI_SCRIPT" "kill-vite"
assert_command_exists "$CLI_SCRIPT" "clear-cache"
