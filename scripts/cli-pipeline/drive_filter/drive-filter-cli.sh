...
show_help() {
  ...
  echo "  add-drive             Add a drive to a profile's excluded list"
  echo "  remove-drive          Remove a drive from a profile's excluded list"
  echo "  list-drives           List all drives excluded by a profile"
