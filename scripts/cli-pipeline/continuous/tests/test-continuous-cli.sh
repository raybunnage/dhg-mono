...
# Test suite for continuous CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../continuous-cli.sh"

# Initialize test environment
init_test_environment "continuous CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "continuous"
...
assert_command_exists "$CLI_SCRIPT" "schedule"
