...
# Test suite for deprecation CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../deprecation-cli.sh"

# Initialize test environment
init_test_environment "deprecation CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "deprecation"
...
assert_command_exists "$CLI_SCRIPT" "mark-deprecated"
