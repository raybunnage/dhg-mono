...
WITH RECURSIVE folder_hierarchy AS (
    ...
    WHERE 
        ...
        AND (
            ...
            parent_folder_id NOT IN (SELECT drive_id FROM google_sources) -- External parent
        )
...
UPDATE google_sources transcript
SET main_video_id = video.id
FROM google_sources video
WHERE 
