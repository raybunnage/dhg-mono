...
# Test suite for database CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../database-cli.sh"

# Initialize test environment
init_test_environment "database CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "database"
...
assert_command_exists "$CLI_SCRIPT" "table-records"
assert_command_exists "$CLI_SCRIPT" "empty-tables"
assert_command_exists "$CLI_SCRIPT" "connection-test"
assert_command_exists "$CLI_SCRIPT" "db-health-check"
