...
# Test suite for service_dependencies CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../service-dependencies-cli.sh"

# Initialize test environment
init_test_environment "service_dependencies CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "service_dependencies"
...
assert_command_exists "$CLI_SCRIPT" "analyze"
assert_command_exists "$CLI_SCRIPT" "visualize"
assert_command_exists "$CLI_SCRIPT" "check"
assert_command_exists "$CLI_SCRIPT" "update"
assert_command_exists "$CLI_SCRIPT" "scan"
