...
# Test suite for monitoring CLI pipeline
...
CLI_SCRIPT="$SCRIPT_DIR/../monitoring-cli.sh"

# Initialize test environment
init_test_environment "monitoring CLI Pipeline"
...
assert_command_output_contains "$CLI_SCRIPT help" "monitoring"
...
assert_command_exists "$CLI_SCRIPT" "check-health"
