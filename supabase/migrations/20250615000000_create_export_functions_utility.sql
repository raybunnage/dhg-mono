-- Migration: Create function to export all PostgreSQL functions to JSON
-- Description: This migration adds a utility function that exports all database functions as JSON

-- Function to export all PostgreSQL functions to JSON
